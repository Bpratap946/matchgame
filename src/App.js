...
class App extends Component {
  ...
  onClickMatchImage = id => {
    ...
    if (id === matchImage.id) {
      ...
      this.setState({
        matchImage: imagesList[randomNumber],
      })
      this.increaseScore()
    } else {
      this.setTimerCondition()
  ...
  render() {
    const {matchImage, activeTabId, score, isTimerZero, time} = this.state
      ...
      <div className="app_container">
        <nav className="header">
          <ul className="nav_item">
            ...
            <li className="score_and_timer_container">
              <p className="header_score">
                Score: <span className="score_count">{score}</span>
              </p>
            ...
            <div className="scorecard_container">
              ...
              <div className="btn_container">
                ...
                >
                  ...
                  />
                  <p className="btn_text">PLAY AGAIN</p>
                </button>
              </div>
            </div>
          ) : (
            <div className="game_container">
              <img src={imageUrl} alt="match" className="match_image" />
              <ul className="tab_items_container">
              ...
              <ul className="thumbnail_items_container">
